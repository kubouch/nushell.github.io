import{_ as s,o as t,c as o,a as e,t as a,d as r,e as c}from"./app.2d203f25.js";const i={},l={id:"frontmatter-title",tabindex:"-1"},p=e("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),d=r(),u={style:{"white-space":"pre-wrap"}},h=c(`<h2 id="signature" tabindex="-1"><a class="header-anchor" href="#signature" aria-hidden="true">#</a> Signature</h2><p><code>&gt; ansi (code) --escape --osc --list</code></p><h2 id="parameters" tabindex="-1"><a class="header-anchor" href="#parameters" aria-hidden="true">#</a> Parameters</h2><ul><li><code>code</code>: the name of the code to use like &#39;green&#39; or &#39;reset&#39; to reset the color</li><li><code>--escape</code>: escape sequence without the escape character(s)</li><li><code>--osc</code>: operating system command (ocs) escape sequence without the escape character(s)</li><li><code>--list</code>: list available ansi code names</li></ul><h2 id="notes" tabindex="-1"><a class="header-anchor" href="#notes" aria-hidden="true">#</a> Notes</h2><div class="language-text ext-text"><pre class="language-text"><code>For escape sequences:
